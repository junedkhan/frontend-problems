...
function fetchFeatureFlagsFromAPI() {
...
function getFeatureFlag(name, defaultValue) {
    return new Promise((resolve, reject) => {
        ...
        fetchFeatureFlagsFromAPI()
            ...
            CACHE.queue.forEach((queuedRequest) => queuedRequest.resolve(queuedRequest.defaultValue));
            CACHE.queue = [];
